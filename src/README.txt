...
| 2 | `long double acos(double x)` | вычисляет арккосинус |  NOT DONE | NOT CHECKED
| 3 | `long double asin(double x)` | вычисляет арксинус |  NOT DONE | NOT CHECKED 
| 4 | `long double atan(double x)` | вычисляет арктангенс |  NOT DONE | NOT CHECKED
...
| 10 | `long double fmod(double x, double y)` | остаток операции деления с плавающей точкой | NOT DONE | NOT CHECKED
| 11 | `long double log(double x)` | вычисляет натуральный логарифм | DONE | BUG FOUND   +(need to check near EXP(1))
